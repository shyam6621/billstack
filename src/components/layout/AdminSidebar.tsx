...
import { BarChart3, Bell, FileText, LayoutDashboard, LogOut, ShieldAlert, TrendingUp, Users, Zap, type LucideIcon } from 'lucide-react';
    ...
    <aside className="hidden min-h-screen w-64 flex-col border-r border-sidebar-border bg-sidebar text-sidebar-foreground md:flex">
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto px-3 py-4">
        <div className="px-3 pb-2 pt-4">
          <p className="text-xs font-semibold uppercase tracking-wider text-sidebar-foreground/40">Admin Panel</p>
        </div>
        {adminLinks.map((link) => <SidebarItem key={link.to} {...link} />)}
      </nav>
        ...
        <div className="mb-3 px-3">
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="truncate text-[10px] text-sidebar-foreground/40">Admin</p>
            </div>
          </div>
        </div>
